...
xterm -geometry 100x16+650+0 -e "cd ..; . debugenv; cd apps; ./toa_server.py -c toa_config_test.ini" &
xterm -geometry 100x16+1300+0 -e "cd ..; . debugenv; cd apps; ./toa_gui.py -c toa_config_test.ini" &
sleep 5
